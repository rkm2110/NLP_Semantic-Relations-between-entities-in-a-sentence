...
# Encoding text to numerical values
# test_X_vectorized, training_Y_vectorized, vectorizer, encoder = fe.data_vectorization(training_X, training_Y)
...
for i in range(0, len(unique_label)):
    ...
    print(unique_label[i], extra_space_class, "     ", training_precision[i], extra_space_precision, "     ", training_recall[i], extra_space_recall, "     ", training_f_score[i])
print("-----------------------------------------------------------------------------------------------------------")
extra_space_class = ""
if len("Overall") < 25:
...
if len(str(training_results1[1])) < 19:
    ...
    while needed_space > 0:
        extra_space_recall = extra_space_recall + " "
        needed_space = needed_space - 1
print("Overall", extra_space_class, "     ", training_results1[0], extra_space_precision, "     ", training_results1[1], extra_space_recall, "     ", training_results1[2])
